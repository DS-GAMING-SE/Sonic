...
namespace SonicTheHedgehog.Modules
{
    public static class Items
    {
        ...
        {
            yellowEmerald = AddNewItem("Chaos Emerald: Yellow", "YELLOW_EMERALD", true, ItemTier.NoTier,
            ...
            purpleEmerald = AddNewItem("Chaos Emerald: Purple", "PURPLE_EMERALD", true, ItemTier.NoTier,
        ...
        internal static ItemDef AddNewItem(string itemName, string token, bool canRemove, ItemTier itemTier, Sprite icon, GameObject pickupModelPrefab)
        {
