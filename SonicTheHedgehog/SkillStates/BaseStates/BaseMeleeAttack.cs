...
namespace SonicTheHedgehog.SkillStates.BaseStates
{
    public class BaseMeleeAttack : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            base.characterMotor.velocity +=base.characterDirection.forward;
        ...
        {
            base.PlayCrossfade("Gesture, Override", "Slash" + (1 + swingIndex%2), "Slash.playbackRate", this.duration, 0.05f);
        }
